...
class UNet(nn.Module):
    def __init__(self):
        ...
        # Contracting path
        self.enc1_1 = CBR2d(in_channels=1, out_channels=128) #인코더의 첫번째 스테이지 
        ...
        self.dec4_2 = CBR2d(in_channels=2 * 1024, out_channels=1024) #들어가는 채널 512아니고 1024
        ...
        #1x1 conv 레이어 추가 
        self.fc = nn.Conv2d(in_channels=128, out_channels=1, kernel_size=1, stride=1, padding=0, bias=True)
#레이어 연결하기 
    def forward(self, x):
